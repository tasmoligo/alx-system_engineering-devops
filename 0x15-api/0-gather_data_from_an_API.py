...
if __name__ == "__main__":
    ...
    employee_todos = requests.get(url + "/todos", params={"userId": sys.argv[1]}).json()
    completed_tasks = [task.get("title") for task in employee_todos if task.get("completed") is True]
